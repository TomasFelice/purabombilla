    ...
    return (
        <div className="flex flex-col min-h-screen bg-muted/30">
            <header className="bg-card border-b px-6 py-4 flex items-center justify-between sticky top-0 z-10 border-border">
                ...
                <div className="text-sm text-muted-foreground font-medium">Nuevo Producto</div>
            </header>

            <main className="flex-1 p-6">
                <div className="max-w-4xl mx-auto mb-6">
                    <h2 className="text-2xl font-bold text-foreground mb-2">Agregar Producto</h2>
                    <p className="text-muted-foreground mb-6">Completa el formulario para agregar un nuevo producto al catálogo.</p>
